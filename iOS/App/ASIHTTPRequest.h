...
@interface ASIHTTPRequest : NSOperation <NSCopying> {
	...
	__strong id <ASIProgressDelegate> uploadProgressDelegate;
	...
	__strong id <ASIProgressDelegate> downloadProgressDelegate;
...
+ (void)updateProgressIndicator:(__strong id <ASIProgressDelegate> *)indicator withProgress:(unsigned long long)progress ofTotal:(unsigned long long)total;
