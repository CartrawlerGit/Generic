...
@property (assign, nonatomic, setter=setUploadProgressDelegate:) id <ASIProgressDelegate> uploadProgressDelegate;
@property (assign, nonatomic, setter=setDownloadProgressDelegate:) id <ASIProgressDelegate> downloadProgressDelegate;
